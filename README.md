...
Нужен **WebGL2** (Chrome 56+, Safari 15+, Firefox 51+). Играть можно в обеих
ориентациях; в начале матча игра сама запрашивает полный экран, а на iPhone
достаточно добавить её на экран «Домой». Матч считается целиком на устройстве:
игра полностью работоспособна без сервера.
